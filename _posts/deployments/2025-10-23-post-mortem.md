...
Yet another malicous (AI?) bot crawling OBS resources and us failing to handle this traffic somehow. The downtime was caused by a failure in our firewall configuration, apparently firewalld/nftables does not like if you have overlapping IP ranges.
...
But also mending the symptoms by introducing traffic priorization or and "blocking" illegitimate traffic by rate limiting, proof-of-work/javascript gating ([berghain](https://github.com/DropMorePackets/berghain)) and in general getting faster at identifying and blocking sources.
...
- 2025-10-15 15:37 We fixed the firewall configration, system are back online