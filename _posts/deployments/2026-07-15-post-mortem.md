...
A low-level release led to a large amount of interconnect traffic which, combined with a large amount of authenticated traffic, saturated the backend capabilities until it stopped responding.
